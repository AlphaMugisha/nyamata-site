...
<section class="about-section" style="background: white; padding: 80px 0;">
    <div class="container">
        <h2 class="section-title">OUR ADVENTIST FAITH</h2>
        <p class="about-subtitle" style="text-align: center; margin-bottom: 40px;">Rooted in scripture, focused on holistic living, and waiting for His return.</p>
        <div class="grid-3">
